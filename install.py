...
if not (argsp.u or argsp.uninstall):
    ...
    https://maven.jans.io/maven/io/jans/scim-plugin/1.0.0-SNAPSHOT/scim-plugin-1.0.0-SNAPSHOT.jar    download(urljoin(maven_base_url, 'scim-plugin/{0}{1}/scim-plugin-{0}{1}-distribution.jar'.format(app_versions['JANS_APP_VERSION'], app_versions['JANS_BUILD'])), os.path.join(jans_app_dir, 'scim-plugin.jar'))
